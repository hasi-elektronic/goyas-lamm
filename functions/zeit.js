...
select.pause,input.pause{width:100%;font:inherit;font-size:1.05rem;padding:.85rem .8rem;border-radius:3px;
  border:1px solid rgba(244,247,234,.24);background:#0F0D0C;color:#fff;margin-bottom:.2rem}
/* Datumsfelder ziehen sich sonst auf ihre Inhaltsbreite zusammen und stehen
   verloren links in der Karte. */
input.pause[type=date]{-webkit-appearance:none;appearance:none;min-height:52px}
input.pause::-webkit-calendar-picker-indicator{filter:invert(1);opacity:.7}
